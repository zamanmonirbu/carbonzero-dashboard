...
export default function Adduser({
  ...
  return (
    <div className="border border-[#09B850] rounded-lg p-6">
      <h1 className="text-2xl font-bold text-center mb-2">Add User</h1>
      <p className="text-gray-500 text-center text-sm mb-6">
        Continue to register as a user, Please provide the information.
      </p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          {addAdminmutation.isPending ? "User Added..." : "Add User"}
        </Button>
      </form>
    </div>
  );
